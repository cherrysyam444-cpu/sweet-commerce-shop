  ...
  head: () => ({
    meta: [
      ...
      { title: "CHERRY SHOP — Shop Smart. Live Better." },
      {
        name: "description",
        content:
          "CHERRY SHOP is a modern online store for electronics, fashion, shoes, watches, beauty, home and fitness. Free shipping over $150.",
      },
      { name: "author", content: "CHERRY SHOP" },
      { property: "og:title", content: "CHERRY SHOP — Shop Smart. Live Better." },
      {
        property: "og:description",
        content: "Discover quality products at prices you'll love. Free shipping over $150.",
      },
